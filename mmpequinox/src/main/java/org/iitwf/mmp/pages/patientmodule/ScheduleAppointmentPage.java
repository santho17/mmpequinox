...
import org.iitwf.selenium.mmpequinox.FutureDataEx;
...
public class ScheduleAppointmentPage {
	...
	public HashMap<String, String> bookAppointment(int n , String format,String specialization,String doctorName  ) throws IOException
	{
		...
		String expectedDate= FutureDataEx.getFutureDate(n,format);
		...
		expectedHMap.put("date", FutureDataEx.getFutureDate(n,"MM/dd/YYYY"));
		...
		screenshotUtil.captureScreenshot("Schedule Appointment_Step2_1");
		...
		screenshotUtil.captureScreenshot("Schedule Appointment_Step2_2");
