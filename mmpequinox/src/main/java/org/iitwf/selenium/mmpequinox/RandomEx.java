...
public class RandomEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("3 digit random number is: " +digit_3);
		
		digit_3 = generateRandomDigits(lBound, uBound);
		System.out.println("8 digit random number from function: " +digit_3);
		
		String randomString = generateRandomString("AUTTeamName");
	...
	public static String generateRandomString(String Str) {
		...
		System.out.println("Lower case Char is: " +lowerCaseCh);
